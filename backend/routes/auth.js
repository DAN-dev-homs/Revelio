...
router.post('/login', (req, res) => {
  ...
  const hasWelcome = req.db.prepare(
  ...
  logActivity(req.db, user.id, 'login', `User logged in: ${email}`, req.ip);
...
router.post('/register', (req, res) => {
  ...
  logActivity(req.db, result.lastInsertRowid, 'register', `New user registered: ${email}`, req.ip);
